...
HD_PWD='C:/Users/abbas/Desktop/CA/CALab-Git-Saqib-Abbas/Lab9/Lab9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_control.tcl -notrace
