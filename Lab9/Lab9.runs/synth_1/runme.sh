...
HD_PWD='C:/Users/abbas/Desktop/CA/CALab-Git-Saqib-Abbas/Lab9/Lab9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_control.tcl
