...
HD_PWD='C:/Users/Saqib Rehman/Desktop/CALab/CA_Lab/CA_Lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_counter_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm_counter_top.tcl -notrace
