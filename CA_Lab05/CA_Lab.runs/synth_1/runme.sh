...
HD_PWD='C:/Users/Saqib Rehman/Desktop/CALab/CA_Lab/CA_Lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_counter_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_counter_top.tcl
